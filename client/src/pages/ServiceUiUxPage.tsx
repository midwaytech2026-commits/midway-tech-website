...
import {
  Search, Map, Palette, Zap, LayoutGrid, Handshake, RefreshCw,
  Rocket, Smartphone, Bot
} from 'lucide-react'
...
const included = [
  ...
  { Icon: LayoutGrid, title: 'Design System',               desc: 'Reusable component library with tokens, typography scale, colour palette, and spacing rules.' },
  ...
  { Icon: RefreshCw,  title: '2 Revision Rounds',            desc: 'Two full rounds of design revisions are included before final delivery — no hidden revision fees.' },
]
